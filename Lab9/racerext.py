...
SCORE = 0
COINS = 0
N = 5  # Number of coins needed to increase enemy speed
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.weight = random.choice([1, 2, 3])  # Random weight for coins
...
# Counter for increasing enemy speed
...
while running:
    ...
    for coin in pygame.sprite.spritecollide(P1, coins, True):
        COINS += 1
        SCORE += coin.weight  # Increase score based on coin weight
        enemy_speed_counter += 1  # Increase counter for increasing enemy speed

        #Increase enemy speed
        if enemy_speed_counter >= 7:
            SPEED += 1
            enemy_speed_counter = 0  # Reset counter
